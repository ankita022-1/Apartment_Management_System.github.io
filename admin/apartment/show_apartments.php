...
<body class="vh-100 gradient-custom" id="bod">
    ...
    <section class="vh-200 gradient-custom">
        <div class="containerp py-5 h-200">
                <h2 class="fw-bold mb-2 text-uppercase" style="color:black; font-weight:bold; ">Your Apartment Details</h2>
            ...
            <div class="card bg-light text-dark col  border-outline-success tab"
                ...
                <tbody>
                    ...
                    // natural join of apartment and admin
                    $selectQuery="select * from apartment_info as i, admin as a where i.Admin_id=a.Admin_id and a.admin_id=$admin_id ";  
