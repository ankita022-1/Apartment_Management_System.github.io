...
<body class="vh-100 gradient-custom" id="bod">
    ...
    <section class="vh-200 gradient-custom">
        <div class="containerp py-5 h-200">
           <h2 class="fw-bold mb-2 text-uppercase" style="color:black; font-weight:bold;">Your Flat Details</h2>
            ...
            <div class="card bg-light text-dark col  border-outline-success tab"
                ...
                <tbody>
                    ...
                    $selectQuery="select * from Flat as f where f.Admin_id=$admin_id";
                    ...
                    while($res=mysqli_fetch_array($query)){                                                                    
                        ...
                        <td style="color:black; font-weight: bold;"><?php echo $res['Flat_number']; ?> </td>
                        <td style="color:black; font-weight: bold;"><?php echo $res['Floor_number']; ?> </td>
                        <td style="color:black; font-weight: bold;"><?php echo $res['Type']; ?> </td>
                        <td style="color:black; font-weight: bold;"><?php echo $res['Price']; ?> </td>                        
                        <td style="color:black; font-weight: bold;"><?php echo $res['Available']; ?> </td>
                        ...
                        <td><a href="UpdateQuery.php?flat_id=<?php echo $res['Flat_id']; ?>" data-toggle="tooltip" data-placement="bottom" title="Update" class="box"><i class="fa fa-edit " aria_hidden="true"></i></a></td>

                        <td><a href="deleteQuery.php?flat_id=<?php echo $res['Flat_id']; ?>" data-toggle="tooltip" data-placement="bottom" title="Delete" class="box"><i class="fa fa-trash " aria_hidden="true"></i></a> </td>
                         </tr>                         
                        <?php
                    }
                    ?>  
